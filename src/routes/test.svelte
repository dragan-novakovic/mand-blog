...
<div class="controls">
  ...
  <label>
    <input type="range" bind:value={w} min={0.1} max={5} step={0.1} />
    width ({w})
  </label>

  <label>
    <input type="range" bind:value={h} min={0.1} max={5} step={0.1} />
    height ({h})
  </label>

  <label>
    <input type="range" bind:value={d} min={0.1} max={5} step={0.1} />
    depth ({d})
  </label>
</div> -->
-->
